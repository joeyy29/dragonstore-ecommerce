            ...
            <div class="check-form">    
                ...
                <div style="display:flex">
                    <div style="width:50%">
                        ...
                        <div style="width:50%">
                            <label class="formm-label">CVV</label>
                            <input  style ="width:90%" type="text" class="formm" placeholder="CVV" required>
                        </div>
                    </div>    
                    <div style="display:flex ">
                        <div style="width:50%">
                            <label class="formm-label ">country</label>
                            <input type="text" class="formm" style ="width:90%" placeholder="South Africa" required>
                        </div>
                        <div style="width:50%">
                            <label class="formm-label">Postal Code</label>
                            <input  style ="width:90%" type="number" class="formm" placeholder="0086" required>
                        </div>
                    </div>
                    <div>
                ...
                <div class="cartt-summary">
                    ...
                    <div class="sum">
                        <h5>Subtotal</h5>
                        <h4><?php echo $_SESSION['total-bd']?> ZAR</h4>
                    </div>
                    <div class="sum">
                        <h5>-<?php echo($_SESSION['per']>100)?0:$_SESSION['per']?>%</h5>
                        <div class="discount-price">-<?php echo $_SESSION['ds']?> </div>
                    </div>
                    <div class="sum">
                        <h5>Delivery Fee</h5>
                        <h4>100 ZAR</h4>
                    ...
                    <div class="sum">
                        <h5>Total</h5>
                        <h4><?php echo $_SESSION['total']?> ZAR</h4>
                    </div>
                </div>
            </div>   
        </section>
